...
# call the script to create the channel, join the peers of doctor and laboratory,
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    docker volume rm docker_orderer.hospital_network.com docker_peer0.doctor.hospital_network.com docker_peer0.laboratory.hospital_network.com
    ...
    docker run --rm -v "$(pwd):/data" busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/doctor/msp organizations/fabric-ca/doctor/tls-cert.pem organizations/fabric-ca/doctor/ca-cert.pem organizations/fabric-ca/doctor/IssuerPublicKey organizations/fabric-ca/doctor/IssuerRevocationPublicKey organizations/fabric-ca/doctor/fabric-ca-server.db'
